...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-amber-500 p-4 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
      <img
        src={image}
        alt={name}
      ...
      <p className="text-lg text-slate-950 mb-4">${price.toFixed(2)}</p>
